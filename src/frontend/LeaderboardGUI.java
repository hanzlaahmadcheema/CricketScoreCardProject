...
public class LeaderboardGUI extends BackgroundPanel {
    ...
    public LeaderboardGUI(Image backgroundImage) {
        ...
        leaderboardTable.getTableHeader().setFont(new Font("Monospaced", Font.BOLD, 16));
        JScrollPane tableScrollPane = new JScrollPane(leaderboardTable);
        tableScrollPane.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(0, 102, 204)), "Leaderboard", TitledBorder.LEFT, TitledBorder.TOP, new Font("Monospaced", Font.BOLD, 18), new Color(0, 102, 204)));
